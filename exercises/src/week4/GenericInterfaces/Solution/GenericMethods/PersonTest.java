package week4.GenericInterfaces.Solution.GenericMethods;
...
public class PersonTest {
	...
	public static void main(String[] args) {
		...
		Arrays.sort(people); // by age based on implementation of Comparable<E>
		System.out.println("\nThe sorted list of people by AGE is:\n");
		print(people);

		Arrays.sort(people, Person.ByName); // by name based on implementation
											// of Comparator<E>
